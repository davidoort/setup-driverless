...
class KeyTeleop():
    ...
    def __init__(self, interface):
        ...
        forward_max = rospy.get_param('~turbo/linear_forward_max', 100.0)
        self._forward = Velocity(forward_min, forward_max, self._num_steps)

        backward_min = rospy.get_param('~turbo/linear_backward_min', 0.5)
        backward_max = rospy.get_param('~turbo/linear_backward_max', 20)
        self._backward = Velocity(backward_min, backward_max, self._num_steps)

        angular_min = rospy.get_param('~turbo/angular_min', 0.7)
        angular_max = rospy.get_param('~turbo/angular_max', 2)
...
class SimpleKeyTeleop():
    def __init__(self, interface):
        ...
        self._backward_rate = rospy.get_param('~backward_rate', 2)
