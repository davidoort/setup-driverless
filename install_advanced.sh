...
#This is an adapted version from Kathleen's and Kieran's installation scripts
...
# Install ROS libraries and plugins
...
echo If you\'re working on perception or ML, please go to https://github.com/DUT-Racing/DUT18D_PerceptionCV/blob/master/utilities/install_content/machine_setup.md and follow the instructions there!
